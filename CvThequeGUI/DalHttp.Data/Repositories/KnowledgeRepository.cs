...
namespace DalHttp.Data.Repositories
{
    public class KnowledgeRepository : IKnowledgeRepository<int, Knowledge>
    {
        ...
        public bool Create(Knowledge entity)
        {
            try
            {
                using (HttpClient client = new HttpClient())
                {
                    ...
                    using (HttpContent _HttpContent = new StringContent(Json))
                    {
                        ...
                        HttpResponseMessage _response = client.PostAsync("Knowledge", _HttpContent).Result;
        ...
        public bool Delete(int Id)
        {
            try
            {
                using (HttpClient client = new HttpClient())
                {
                    ...
                    using (HttpResponseMessage _response = client.DeleteAsync("Knowledge/" + Id).Result)
                    {
                        return _response.IsSuccessStatusCode;
                    }
                }
        ...
        public IEnumerable<Knowledge> GetAll()
        {
            try
            {
                using (HttpClient client = new HttpClient())
                {
                    ...
                    using (HttpResponseMessage _response = client.GetAsync("Knowledge").Result)
                    {
                        _response.EnsureSuccessStatusCode();
                        using (HttpContent _content = _response.Content)
                        {
                            string result = _content.ReadAsStringAsync().Result;
                            return JsonConvert.DeserializeObject<Knowledge[]>(result);
                        }
                    }
                }
            }
        ...
        public Knowledge GetOne(int Id)
        {
            try
            {
                using (HttpClient client = new HttpClient())
                {
                    ...
                    using (HttpResponseMessage _response = client.GetAsync("Knowledge/" + Id).Result)
                    {
                        _response.EnsureSuccessStatusCode();
                        using (HttpContent _content = _response.Content)
                        {
        ...
        public bool Update(int Id, Knowledge entity)
        {
            try
            {
                using (HttpClient client = new HttpClient())
                {
                    ...
                    {
                        _HttpContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                        HttpResponseMessage _response = client.PutAsync("Knowledge/" + Id, _HttpContent).Result;
                        return _response.IsSuccessStatusCode;
                    }
                }
            }
