...
namespace DalHttp.Data.Repositories
{
    public class KnowledgeTypeRepository : IKnowledgeTypeRepository<int, KnowledgeType>
    {
        ...
        public bool Create(KnowledgeType entity)
        {
            try
            {
                using (HttpClient client = new HttpClient())
                {
                    ...
                    using (HttpContent _HttpContent = new StringContent(Json))
                    {
                        ...
                        HttpResponseMessage _response = client.PostAsync("KnowledgeType", _HttpContent).Result;
        ...
        public bool Delete(int Id)
        {
            try
            {
                using (HttpClient client = new HttpClient())
                {
                    ...
                    using (HttpResponseMessage _response = client.DeleteAsync("KnowledgeType/" + Id).Result)
                    {
                        return _response.IsSuccessStatusCode;
                    }
                }
        ...
        public IEnumerable<KnowledgeType> GetAll()
        {
            try
            {
                using (HttpClient client = new HttpClient())
                {
                    ...
                    using (HttpResponseMessage _response = client.GetAsync("KnowledgeType").Result)
                    {
                        _response.EnsureSuccessStatusCode();
                        using (HttpContent _content = _response.Content)
                        {
                            string result = _content.ReadAsStringAsync().Result;
                            return JsonConvert.DeserializeObject<KnowledgeType[]>(result);
                        }
                    }
                }
            }
        ...
        public KnowledgeType GetOne(int Id)
        {
            try
            {
                using (HttpClient client = new HttpClient())
                {
                    ...
                    using (HttpResponseMessage _response = client.GetAsync("KnowledgeType/" + Id).Result)
                    {
                        _response.EnsureSuccessStatusCode();
                        using (HttpContent _content = _response.Content)
                        {
        ...
        public bool Update(int Id, KnowledgeType entity)
        {
            try
            {
                using (HttpClient client = new HttpClient())
                {
                    ...
                    using (HttpContent _HttpContent = new StringContent(Json))
                    {
                        ...
                        using (HttpResponseMessage _response = client.PutAsync("KnowledgeType/" + Id, _HttpContent).Result)
                        {
                            return _response.IsSuccessStatusCode;
                        }
                    }
